...
- **Study it.** The codebase demonstrates Rust injection toolkit patterns, Vulkan hooking, cross-platform IPC, and containerized CI/CD with agent-driven development.
- **Use it.** You are free to use any component under the terms of the [MIT License](LICENSE-MIT).
